...
SUB16:
		...
		ld r3, X						; Load first low byte into A
		ld r4, Y						; Load first high byte into B
		SBC r3, r4						; Subtract second low byte to first
		ST Z+, r3
		brcc EXIT_SUB
		ldi mpr, 0x01
		ST Z, mpr
...
MUL24:
		...
		; Set Y to beginning address of operator 2 
...
MUL24_OLOOP:
		; Set X to beginning address of operator 1
...
; Multiplication memory allocation
.org	$0110
MUL24_OP1:	
		.byte 3
MUL24_OP2:	
